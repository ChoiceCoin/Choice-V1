...
# Put in main creator address here. This is the account that you want to be the manager of the asset.
creator_address = ""
creator_mnemonic = "" 
...
# Go to the algoexplorer link that is returned to get a validated transaction.
# Record the asset_id and any other details you want.
def create_asset():
